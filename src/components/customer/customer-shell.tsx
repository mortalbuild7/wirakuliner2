  ...
  return (
      ...
      style={
        {
          "--customer-header-offset":
            "calc(4.25rem + max(0.75rem, env(safe-area-inset-top, 0px)))",
    ...
    >
      ...
      <main className="customer-scroll-layer relative z-0 mx-auto min-h-0 w-full max-w-mobile flex-1 overflow-x-hidden overflow-y-auto overscroll-y-contain safe-pb-nav">
        <header className="customer-app-header sticky top-0 z-[10000] border-b border-slate-200 bg-white shadow-sm">
        ...
        <div className="customer-scroll-content relative z-0 isolate">
          <CustomerModerationBanner />
          {children}
        </div>
      </main>

      <nav className="fixed bottom-0 left-0 right-0 z-[10001] border-t border-slate-200 bg-white pb-[env(safe-area-inset-bottom,0px)] shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
